...
if __name__ == '__main__':
    ...
    img_prompt = "ultra high res, ultra detailed, Bruce Lee is boxing with a icy zombie"
    instance_prompts = [["Bruce Lee", "Naked body surrounded by flames", "icy zombie"]]
    for instance_prompt in instance_prompts[0]:
        img_prompt += ',' + instance_prompt


    instance_box_list = [[0.6666666666666666, 0.015625, 0.8541666666666666, 0.234375], [0.4375, 0.25, 0.8541666666666666, 0.9375], [0.15625, 0.046875, 0.4270833333333333, 0.9375], 
                         ]


    control_image = Image.open("./data/boxing_depth.png")
    ...
    image.save("BruceLee_rendering_sam_enhance.png")
