...
if __name__ == '__main__':
    ...
    img_prompt = "best quality, 4K, two birds."
    instance_prompts = [["bird made by fire", ' bird made by ice', 'black sea']]
    for instance_prompt in instance_prompts[0]:
        img_prompt += ',' + instance_prompt


    instance_box_list = [[0, 0.25, 0.453125, 0.71875], [0.46875, 0.25, 0.875, 0.71875], [0, 0, 1, 0.71875]]


    control_image = Image.open("./data/two_birds_depth.png")
    ...
    image.save("birds_rendering_sam_enhance.png")
