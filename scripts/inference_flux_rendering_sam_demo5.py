...
if __name__ == '__main__':
    ...
    img_prompt = "Albert Einstein, Mona Lisa, and Donald Trump are making love sign."
    instance_prompts = [["Albert Einstein", "Mona Lisa", "Donald Trump", "McDonald's food"]]
    for instance_prompt in instance_prompts[0]:
        img_prompt += ',' + instance_prompt


    instance_box_list = [[0.4, 0.23958333333333334, 0.625, 0.53125], [0, 0.22916666666666666, 0.4125, 0.8541666666666666], [0.625, 0.20833333333333334, 0.9875, 0.8645833333333334], 
                         [0, 0.7916666666666666, 0.9875, 1]]


    control_image = Image.open("./data/love_sign_depth.png")
    ...
    image.save(f"LoveSign_rendering_sam_enhance.png")
